...
import com.nonage.util.DBManager;
...
public class OrderDAO {
	...
	public ArrayList<Integer> selectSeqOrderIng2(String id) {
		ArrayList<Integer> oseqList = new ArrayList<Integer>();
		String sql = "select distinct oseq from order_view " + "where id=? and result='2' order by oseq desc";
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	// 사용자가 주문 내역 검색
		...
		public int maxCSEQ() {
			...
			String sql = "select max(cseq) from CART";
			int maxCSEQ = 0;
			Connection conn = null;
			PreparedStatement pstmt = null;
			ResultSet rs =null;
